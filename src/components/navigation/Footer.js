...
function Footer(){
  return(
    ...
    <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
      ...
      <div className="mt-8 border-t border-red-500 pt-8 md:flex md:items-center md:justify-between">
        <div className="flex space-x-6 md:order-2">
          {navigation.social.map((item) => (
            <a key={item.name} href={item.href} className="text-red-400 hover:text-indigo-500">
        ...
        <p className="mt-8 text-base text-gray-400 md:mt-0 md:order-1">
          &copy; 2022 Mer Inc. Todos los derechos reservados
        </p>
      </div>
    </div>
  </footer>
